...
void OptionsMenu::DrawTitle() {
    ...
    DrawTextEx(GetFontDefault(), OptionsTitle,
               {(GlobalConstants::ScreenSize.x / 2.0f) -
                    text::CenterText(OptionsTitle, FontSize, GetFontDefault()).x,
                50},
               FontSize, 1, BLACK);
}
...
void OptionsMenu::ChangeButtonPos() {
    ...
    ResButton1440 = {(GlobalConstants::ScreenSize.x / 2.0f) * 0.8f,
                     GlobalConstants::ScreenSize.y / 3.0f};
    ResButton720  = {(GlobalConstants::ScreenSize.x / 2.0f) * 1.2f,
                     GlobalConstants::ScreenSize.y / 3.0f};
