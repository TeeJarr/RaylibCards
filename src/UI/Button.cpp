...
void Button::Draw() {
  ...
  DrawTextEx(GetFontDefault(), ButtonText,
             {ButtonLocation.x - text::CenterText(ButtonText, GlobalConstants::FontSize, GetFontDefault()).x,
              ButtonLocation.y - text::CenterText(ButtonText, GlobalConstants::FontSize, GetFontDefault()).y},
...
Rectangle Button::GetBounds() {
  return {ButtonLocation.x - text::CenterText(ButtonText, GlobalConstants::FontSize, GetFontDefault()).x,
          ButtonLocation.y - text::CenterText(ButtonText, GlobalConstants::FontSize, GetFontDefault()).y,
